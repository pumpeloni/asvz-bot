...
def main():
    ...
    sportfahrplan_mit_zeitfilter = args.sportfahrplan + "&date=" + str(start_time.year) + "-" + str(start_time.month) + "-" + str(start_time.day) + "%20" + str(start_time.hour) + ":" + str(start_time.minute)
