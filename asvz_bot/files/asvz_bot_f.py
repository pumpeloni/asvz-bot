...
Updated Version on: November 08, 2020
Author: Marc Zünd
"""

### THIS VERSION USES FIREFOX AS BROWSER ###
...
def asvz_enroll(
    ...
    try:
        ...
        logging.info("Headless Firefox started")
...
def main():
    ...
    enrollment_start_time = enrollment_time.replace(hour=enrollment_time.hour + (24 - enrollemnt_time_difference))
